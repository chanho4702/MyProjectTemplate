...
이 결정만으로 OIDC 로그인, CSRF 방어, token 갱신 또는 운영 CORS 정책이 완성되지는 않는다. 선택형 SPA OIDC의 후속 결정은 [ADR 0003](0003-spa-oidc-public-client.md)에 기록한다. ADR 0003도 BFF/CSRF와 운영 IdP 정책까지 보장하지 않는다.
